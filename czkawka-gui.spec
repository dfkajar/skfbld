...
install -d -m 0755 %{builddir}/%{name}-%{version}/data/com.github.qarmin.czkawka.desktop %{buildroot}%{_datadir}/applications/com.github.qarmin.czkawka.desktop
install -d -m 0755 %{builddir}/%{name}-%{version}/data/com.github.qarmin.czkawka.metainfo.xml %{buildroot}%{_datadir}/metainfo/com.github.qarmin.czkawka.metainfo.xml
install -d -m 0755 %{builddir}/%{name}-%{version}/data/icons/com.github.qarmin.czkawka.svg %{buildroot}%{_datadir}/icons/hicolor/scalable/com.github.qarmin.czkawka.svg
install -d -m 0755 %{builddir}/%{name}-%{version}/data/icons/com.github.qarmin.czkawka-symbolic.svg %{buildroot}%{_datadir}/icons/hicolor/symbolic/com.github.qarmin.czkawka-symbolic.svg
